...
\begin{document}
	...
	\begin{itemize}
		...
		Een elektron zend licht uit wanneer het van een hogere naar een lagere baan springt, en absorbeert licht wanneer het van een lagere naar een hogere baan springt.
	...
	\begin{itemize}
		\item De staboliteit van atomen: \\
   ...
   volgens het waterstofatoom klopt het exact met de experimenten.
	...
	\begin{itemize}
		...
		\item electronen bewegen niet echt in cirkelvormige banen, maar hebben een meer complexe beweging die beter wordt beschreven door de golffunctie in de Schrödingervergelijking.
	\end{itemize}
